...
A conversational, multi-page intake form for The Fortune 5 Agency. No database: every submission
arrives as an email, and uploaded files sit in a private Vercel Blob store.

```
browser ── discovery.befortune5.com (static files + /api on Vercel)
...
| `SITE_URL` | `https://discovery.befortune5.com` | Logo and file links in emails |
| `RESEND_API_KEY` | `re_...` | **You add this.** Sends both emails |
| `FROM_EMAIL` | `The Fortune 5 Agency <hello@befortune5.com>` | **You add this.** Must be on a domain verified in Resend |
| `NOTIFY_TO` | `you@befortune5.com` | **You add this.** Where new submissions land |
| `BOOKING_URL` | optional | Defaults to the befortune5.com booking page |
